...
static const Block blocks[] = {
    ...
    {"^b#d79921^^c#1d2021^  ^b#fabd2f^ ", "block-battery perc BAT0",  					60,	 0},
    {"^b#458588^^c#1d2021^  ^b#83a598^ ", "block-temperature /sys/class/thermal/thermal_zone0/temp",	5,	 0},
    {"^b#98971a^^c#1d2021^  ^b#b8bb26^ ", "block-cpu perc",    					2,	 0},
    {"^b#689d6a^^c#1d2021^  ^b#8ec07c^ ", "block-ram used",    					10,	 0},
    {"^b#b16286^^c#1d2021^  ^b#d3869b^ ", "block-datetime \"%H:%M \"",					60,	 0},
